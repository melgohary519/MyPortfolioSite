...
let projects = [{
  ...
  },
  {
    ...
    name:"DSpace 8 For Fallujah University",
    desc: `
      <p dir="rtl">
        <p dir="rtl">
          المستودع الرقمي لجامعة الفلوجة هو منصة مركزية مخصصة لحفظ وعرض المساهمات الأكاديمية والبحثية والعلمية لأعضاء هيئة التدريس والطلاب والباحثين في الجامعة. تم تصميمه لتسهيل الوصول إلى ثروة من المعرفة والموارد مع تعزيز التعاون والابتكار الأكاديمي.
        </p>
        <p dir="rtl">يوفر المستودع الوصول إلى مجموعة واسعة من المحتويات الرقمية، بما في ذلك:</p>
        <ul dir="rtl">
          <li>
          الأبحاث العلمية: مجموعة من المقالات والدراسات التي تمت مراجعتها من قبل الأقران والتي أجراها باحثو الجامعة.
          </li>
          <li>
          الرسائل الجامعية والأطروحات: أعمال الدراسات العليا التي تمثل مساهمات هامة في مختلف المجالات.
          </li>
          <li>
          المنشورات الأكاديمية: كتب ومجلات ومؤتمرات علمية نشرها المجتمع الأكاديمي.
          </li>
          <li>
          المواد الدراسية: ملاحظات المحاضرات والعروض التقديمية والموارد التعليمية الأخرى للطلاب والمدرسين.
          </li>
          <li>
          المحتوى المتعدد الوسائط: مقاطع فيديو وصور ومواد أرشيفية تدعم التدريس والبحث.
          </li>
        </ul>
      </p>
    `,
    ...
    images: [
      "./assets/img/projects/fallujah/image1.png",
      "./assets/img/projects/fallujah/image2.png",
      "./assets/img/projects/fallujah/image3.png",
      "./assets/img/projects/fallujah/image4.png",
      "./assets/img/projects/fallujah/image5.png"
    ],
    filter: "filter-dspace"
  },
]
